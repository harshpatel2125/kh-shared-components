...
const CustomSelect: React.FC<SelectProps> = ({ options, handleChange }) => {
	...
	return (
		<div className="dropdown min-w-[500px] ">
			<div className="px-4 mt-3 w-fit rounded-md ">
			<div
				tabIndex={0}
				role="button"
				className="w-56  flex font-bold text-left items-left mt-1 mb-1"
			>
			...
			<ul
				tabIndex={0}
				className="dropdown-content menu menu-dropdown-toggle p-2 mt-1 shadow-md z-[9] bg-base-100 rounded-box flex flex-row"
			>
